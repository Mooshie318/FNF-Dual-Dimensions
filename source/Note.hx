	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
	{
		...
		switch (daStage)
		{
			...
			default:
				...
				var fuckingSussy = Paths.getSparrowAtlas('note-lava', 'shared');
				...
				switch(noteType)
				{
					case 2:
					{
						frames = Paths.getSparrowAtlas('note-lava', 'shared');
						animation.addByPrefix('greenScroll', 'lava up');
						animation.addByPrefix('redScroll', 'lava right');
						animation.addByPrefix('blueScroll', 'lava down');
						animation.addByPrefix('purpleScroll', 'lava left');
					...
					case 3:
					{
						frames = Paths.getSparrowAtlas('note-heal', 'shared');
					...
					case 4:
					{
						frames = Paths.getSparrowAtlas('note-lightning', 'shared');
						animation.addByPrefix('greenScroll', 'green');
						animation.addByPrefix('redScroll', 'red');
						animation.addByPrefix('blueScroll', 'blue');
						animation.addByPrefix('purpleScroll', 'purple');
					...
					case 5:
					{
						frames = Paths.getSparrowAtlas('note-fuckyou', 'shared');
						animation.addByPrefix('greenScroll', 'green');
						animation.addByPrefix('redScroll', 'red');
						animation.addByPrefix('blueScroll', 'blue');
						animation.addByPrefix('purpleScroll', 'purple');
					...
					case 6:
					{
						frames = Paths.getSparrowAtlas('note-shell', 'shared');
						animation.addByPrefix('greenScroll', 'green');
						animation.addByPrefix('redScroll', 'red');
						animation.addByPrefix('blueScroll', 'blue');
						animation.addByPrefix('purpleScroll', 'purple');
