...
class DialogueOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.dialogue = !FlxG.save.data.dialogue;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return 'Cringe dialogue ' + (FlxG.save.data.dialogue ? "On" : "Off");
	}
}
...
class CutsceneOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return 'Cringe cutscenes ' + (FlxG.save.data.cutscenes ? "On" : "Off");
	}
}
