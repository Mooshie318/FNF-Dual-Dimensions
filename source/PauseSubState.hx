...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume', 'Restart Song', 'Chart editor', 'Offset editor dad', 'Offset editor bf', 'Exit to menu'];
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case 'Offset editor dad':
					#if windows
					DiscordClient.changePresence("Offset Editor dad", null, null, true);
					#end
				...
				case 'Offset editor bf':
					#if windows
					DiscordClient.changePresence("Offset Editor bf", null, null, true);
					#end
