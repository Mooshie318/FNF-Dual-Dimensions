...
class ReferenceGuessState extends MusicBeatState
{
	...
	function addUI():Void
    {
		...
		txt2.text = 'The boxes are in week order from 4-10';
	...
	{
		if (w4Box.text == w4Answer && w5Box.text == w5Answer && w6Box.text == w6Answer && w7Box.text == w7Answer && w8Box.text == w8Answer && w9Box.text == w9Answer && w10Box.text == w10Answer)
		{
