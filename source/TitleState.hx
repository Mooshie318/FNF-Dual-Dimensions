...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		{
			case 2:
				createCoolText(['mooshie', 'mooshie', 'mooshie', 'mooshie']);
			case 3:
				addMoreText('present');
			case 4:
				deleteCoolText();
			case 5:
				if (Main.watermarks)
					...
					createCoolText(['The mod that', 'nobody asked for']);
			case 7:
				if (Main.watermarks)
					addMoreText('Your mom');
				else
				{
					addMoreText('nor did they need');
					ngSpr.visible = true;
				}
			case 8:
				deleteCoolText();
			...
			case 13:
				deleteCoolText();
				createCoolText(['Friday', 'Night', 'Mooin']);
			case 14:
				addMoreText('Best mod ever');
			case 15:
				addMoreText('E');
			case 16:
				skipIntro();
